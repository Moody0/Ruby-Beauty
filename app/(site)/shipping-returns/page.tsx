                        ...
                        <div className="space-y-8">
                            ...
                            <div className={`${dir === 'rtl' ? 'border-r-2 pr-6 pl-0' : 'border-l-2 pl-6'} border-primary/20 py-2`}>
                                <h3 className="text-xl font-display font-semibold mb-3">
                                    {t('shippingReturnsPage.shipping.verification.title')}
                                </h3>
                                <p className="text-stone-600 dark:text-stone-400 leading-relaxed">
                                    {t('shippingReturnsPage.shipping.verification.description')}
                                </p>
                            </div>
                            ...
                            <div className={`${dir === 'rtl' ? 'border-r-2 pr-6 pl-0' : 'border-l-2 pl-6'} border-primary/20 py-2`}>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-5">
                                    <div className="bg-white dark:bg-stone-900/40 p-4 rounded-lg shadow-sm border border-primary/5">
                                        ...
                                        <p className="text-lg">
                                            {t('shippingReturnsPage.shipping.timelines.standardTime')}
                                        </p>
                                    </div>
                                    <div className="bg-white dark:bg-stone-900/40 p-4 rounded-lg shadow-sm border border-primary/5">
                                        <span className="block font-bold text-primary text-xs uppercase tracking-widest mb-1">
                                        ...
                                        <p className="text-lg">
                                            {t('shippingReturnsPage.shipping.timelines.expressTime')}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className={`${dir === 'rtl' ? 'border-r-2 pr-6 pl-0' : 'border-l-2 pl-6'} border-primary/20 py-2`}>
                                <h3 className="text-xl font-display font-semibold mb-3">
                                    {t('shippingReturnsPage.shipping.review.title')}
                                </h3>
                                <p className="text-stone-600 dark:text-stone-400 leading-relaxed">
                                    {t('shippingReturnsPage.shipping.review.description')}
                                </p>
                            </div>
                        </div>
                        <div className="relative rounded-xl overflow-hidden aspect-[16/9] group">
                            <img alt="Shipping packaging" className="w-full h-full object-cover grayscale-[20%] group-hover:scale-105 transition-transform duration-700" data-alt="A minimalist aesthetic skincare packaging box" src="https://lh3.googleusercontent.com/aida-public/AB6AXuC1GmfD6bueEsJqlHNPjDWHMlhsLZSm2Jmp21TUCLKvobkcd7oAPMMdwzfm8BOHC5XtR0EP6tLI7DT5hhyLxuijsbpX2kQf6iNlqROU-8k-DrqZAUqdc7-0lE4nxuCcLaEb0fEaXVBxc_yXkiUlyhfvaYJ1FfHZtngnoJbeanLgsf7rcxqON6rjkoC4BQv6FhlwLNKZrMbxjCugphq-bo5GCqBoLfmjjZSuH0N5eV-Kz33xFQTD5jSYCTsVYAwOkwhLQsQiPD_lnD9U" />
                        ...
                        <div className="bg-primary text-white p-6 md:p-8 rounded-xl shadow-lg relative overflow-hidden">
                            <div className="relative z-10">
                                <h3 className="text-2xl font-display font-bold mb-3">
                                    {t('shippingReturnsPage.returns.finalSale.title')}
                                </h3>
                                <p className="text-white/90 text-sm leading-relaxed max-w-md">
                                    {t('shippingReturnsPage.returns.finalSale.description')}
                                </p>
                            </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                <h3 className={`text-xl font-display font-semibold mb-4 flex items-center ${dir === 'rtl' ? 'space-x-reverse' : ''} space-x-3`}>
                                    ...
                                    <span>{t('shippingReturnsPage.returns.hygiene.title')}</span>
                                </h3>
                                <p className="text-stone-600 dark:text-stone-400 leading-relaxed">
                                    {t('shippingReturnsPage.returns.hygiene.description')}
                                </p>
                            </div>

                            <div className="bg-primary/5 border border-primary/10 p-6 rounded-xl">
                                <h3 className="text-xl font-display font-semibold mb-4">
                                    {t('shippingReturnsPage.returns.damaged.title')}
                                </h3>
                                <p className="text-stone-600 dark:text-stone-400 mb-5 leading-relaxed">
                                    {t('shippingReturnsPage.returns.damaged.description')}
                                </p>
