        ...
        <>
            ...
            <div className="flex-1 overflow-y-auto bg-background-light dark:bg-background-dark p-4 md:p-8">
                <div className="max-w-[1200px] mx-auto flex flex-col gap-6 md:gap-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                        ...
                        <div className="flex flex-col gap-4 rounded-xl p-5 md:p-6 bg-surface-light dark:bg-surface-dark shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] dark:shadow-none border border-[#e6dbdf]/50 dark:border-gray-700">
                            ...
                            <div>
                                ...
                                <h3 className="text-text-main dark:text-white text-xl md:text-2xl font-bold mt-1">356</h3>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-4 rounded-xl p-5 md:p-6 bg-surface-light dark:bg-surface-dark shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] dark:shadow-none border border-[#e6dbdf]/50 dark:border-gray-700">
                            ...
                            <div>
                                ...
                                <h3 className="text-text-main dark:text-white text-xl md:text-2xl font-bold mt-1">120</h3>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-4 rounded-xl p-5 md:p-6 bg-surface-light dark:bg-surface-dark shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] dark:shadow-none border border-[#e6dbdf]/50 dark:border-gray-700">
                            <div className="flex justify-between items-start">
                                <div className="p-3 bg-primary/10 rounded-lg text-primary">
                                    <span className="material-symbols-outlined filled">reviews</span>
                                </div>
                            </div>
                            <div>
                                <p className="text-text-sub dark:text-gray-400 text-sm font-medium">
                                ...
                                <h3 className="text-text-main dark:text-white text-xl md:text-2xl font-bold mt-1">12</h3>
                            </div>
                        </div>
                    </div>
                                        ...
                                        {[
                                            ...
                                            >
                                                ...
                                                <td className="p-3 md:p-4 text-right">
                                                    <button className="text-text-sub hover:text-text-main dark:text-gray-400 dark:hover:text-white transition-colors">
                    ...
                    <div className="flex justify-center mt-4 md:mt-8 pb-4">
                        <p className="text-text-sub dark:text-gray-400 text-xs">
